package org.lsy.learn.security.generate;
...
import org.lsy.learn.security.generate.convert.MyConvert;
...
public class MysqlGenerator {
    ...
    private static JSONObject parseYaml(Path cf) {
        Yaml yaml = new Yaml();
        try {
            Map<String, Object> configMap = yaml.load(new FileInputStream(cf.toFile()));
